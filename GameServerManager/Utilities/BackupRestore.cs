...
namespace GameServerManager.Utilities
{
    public static class BackupRestore
    {
        ...
        {
            string backupPath = string.IsNullOrWhiteSpace(gameServer.Config.Backup.Directory) ? Path.Combine(GameServerService.DefaultBackupsPath, gameServer.Config.Guid.ToString()) : gameServer.Config.Backup.Directory;
